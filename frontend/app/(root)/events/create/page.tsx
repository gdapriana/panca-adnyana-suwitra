			...
			<div className="w-full max-w-6xl flex justify-center flex-col items-stretch">
				<div className="mb-12">
					...
					<p className="text-muted-foreground">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab adipisci consectetur delectus distinctio earum eligendi
						esse exercitationem fuga illo ipsum modi mollitia porro quod recusandae totam veniam, vero! Alias error ipsam
						molestias neque nesciunt officia quibusdam recusandae temporibus voluptatem voluptatibus!
					</p>
				</div>
