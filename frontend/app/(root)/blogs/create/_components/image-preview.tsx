...
export default function BlogImagePreview({
	...
	return (
		<Label htmlFor="image" className="flex flex-col justify-start items-stretch gap-2">
			Upload gambar
			<Input name="image" id="image" type="file" accept="image/*" onChange={handleFileChange} />
			{preview && (
				<Image
					width={1920}
					height={1080}
