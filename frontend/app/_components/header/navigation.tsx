            ...
            <ul className="grid w-[400px] gap-2 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              {stt.map((component: Stt) => (
                <ListItem
                  ...
                  className={cn("flex flex-col justify-start items-stretch gap-2", component.is_main && "hidden")}
                >
                  {component.description}
                  <div className="flex mt-2 justify-start items-center">
                    <Button variant="outline" size="sm">{component._count!.stt_membership} Anggota</Button>
                  </div>
                </ListItem>
              ))}
            </ul>
